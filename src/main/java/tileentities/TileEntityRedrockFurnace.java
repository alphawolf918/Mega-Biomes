...
import biomemod.blocks.RedRockFurnace;
import cpw.mods.fml.common.registry.GameRegistry;
import cpw.mods.fml.relauncher.Side;
import cpw.mods.fml.relauncher.SideOnly;

public class TileEntityRedrockFurnace extends TileEntityFurnace implements
		ISidedInventory
{
	...
	{
		this.field_94130_e = "Redrock Furnace"; // par1Str;
	}
	...
	public void updateEntity()
	{
		...
		if (!this.worldObj.isRemote)
		{
			...
			{
				flag1 = true;
				RedRockFurnace.updateFurnaceBlockState(
