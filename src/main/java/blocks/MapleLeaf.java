...
public class MapleLeaf extends BlockLeavesBase implements IShearable {
	public static final String[] MapleLEAF_TYPES = new String[] { "Maple" };
	@SideOnly(Side.CLIENT)
	private int field_94394_cP;
	private Icon[][] iconArray = new Icon[2][];
	int[] adjacentTreeBlocks;

	protected MapleLeaf(int par1) {
